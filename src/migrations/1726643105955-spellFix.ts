...
export class SpellFix1726643105955 implements MigrationInterface {
    name = 'SpellFix1726643105955'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" RENAME COLUMN "roll" TO "role"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" RENAME COLUMN "role" TO "roll"`);
